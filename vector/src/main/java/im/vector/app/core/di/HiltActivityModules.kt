...
@Module
@InstallIn(ActivityComponent::class)
object HiltScreenModule {

    @Provides
    @JvmStatic
    fun providesGlideRequests(context: FragmentActivity) = GlideApp.with(context)
