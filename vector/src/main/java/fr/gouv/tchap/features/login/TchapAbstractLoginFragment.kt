 ...
 */
abstract class TchapAbstractLoginFragment<VB: ViewBinding> : VectorBaseFragment<VB>(), OnBackPressed {

    protected val loginViewModel: TchapLoginViewModel by activityViewModel()
    ...
    private fun handleLoginViewEvents(loginViewEvents: TchapLoginViewEvents) {
        when (loginViewEvents) {
            is TchapLoginViewEvents.Failure -> showFailure(loginViewEvents.throwable)
            else                       ->
