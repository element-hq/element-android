...
./gradlew assembleGplayNightly appDistributionUploadGplayNightly "-Porg.gradle.jvmargs=-XX:MaxRAM=7g -Xmx2g -XX:MaxMetaspaceSize=1g" -Porg.gradle.parallel=false -Dfile.encoding=UTF-8 --stacktrace
```
